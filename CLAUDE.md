...
**总体设计见 [`docs/design/`](docs/design/README.md)（第一册·顶层设计已冻结 v1.0，tag: design-t1-v1.0；T1-03c 已按升版纪律升至 v1.1——完整 PortMap/坐标系声明/簇初相，2026-07-16。第二册·功能设计已冻结 v1.0，tag: design-t2-v1.0，2026-07-16——11 模块 + T1-15 设计问答/B+ 播放基线）**。关键约定：
