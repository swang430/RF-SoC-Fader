...
**总体设计见 [`docs/design/`](docs/design/README.md)（第一册·顶层设计已冻结 v1.0，tag: design-t1-v1.0；T1-03c 已按升版纪律升至 v1.2——v1.1 完整 PortMap/坐标系声明/簇初相 + v1.2 逐径 DOPPLER（`Ray.doppler_hz?`，随 MPDB 手册 v1.1/HyperRT v3.2.6），2026-07-16。第二册·功能设计已冻结 v1.0，tag: design-t2-v1.0，2026-07-16——11 模块 + T1-15 设计问答/B+ 播放基线。第三册·测试设计已冻结 v1.0，tag: design-t3-v1.0，2026-07-17——T3-00 治理总则～T3-05 CI/发布/验收六篇，测试作为独立监督册约束功能开发，含 HIL 两级环）**。关键约定：
