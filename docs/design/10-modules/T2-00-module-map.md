...
> 第二册《功能设计》· 开册篇
> 状态：**v1.0 · 已冻结**（2026-07-16，tag: design-t2-v1.0——11 模块经 PR #7–#17 评审合并、Codex 累计 200+ 条发现闭环，另经 T1-15 设计问答与收官审查 PR #20）
...
| T2-10 | [格式与持久化](T2-10-formats-persistence.md) | M10：codec 注册表、I/O 适配层、配置 repository、blob | schema | ✅ 已合并（PR #16，Codex 36 条闭环） |
| T2-11 | [GUI](T2-11-gui.md) | M11：五视图细化（依《T1-14》，Web） | M7（运行时）, M9（语义对照） | ✅ 已合并（PR #17，Codex 26 条 + 预审 13 条闭环） |
