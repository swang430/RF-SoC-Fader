...
| 03c | [信道 Schema（规范契约）](00-overall/03c-channel-schema.md) | canonical model 字段级规范、MPDB↔schema 映射 |
...
- **第二册 · 模块设计** `10-modules/`：M1 协议编解码 · M2 设备后端/传输 · M3 引擎集成 · M4 MPDB 导入 · M5 相关性 · M6 场景会话 · M7 API 网关 · M8 遥测校准 · M9 SDK/客户端 · **M10 格式与持久化(File I/O)**。
