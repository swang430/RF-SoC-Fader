...
- **第三册 · 测试设计** `20-dev-test/`（**进行中**，2026-07-16 起；原 T1–T5 模块代号为避免与册号撞名改为 `T3-01…T3-05`）：[T3-00 测试治理总则](20-dev-test/T3-00-test-governance.md)（监督五原则/金字塔/追溯矩阵/挂账盘点/HIL 两级环，已合并）· [T3-01 测试仓库与流程](20-dev-test/T3-01-test-repo-process.md)（测试树/用例 ID/fixture 主权/测试栈/矩阵载体四查，已合并）· [T3-02 测试金字塔详规](20-dev-test/T3-02-pyramid-detail.md)（L1/L2 收编规约/五条补缺/L3-L4 矩阵/负向总账，已合并）· [T3-04 黄金一致性](20-dev-test/T3-04-golden-conformance.md)（G1–G11 资产登记/两条铁律/重录纪律，评审中）· 待展开：T3-03 硬件在环 · T3-05 CI/发布/验收——推进序 01→02→04→03→05，**测试先行**：T3-01/02/04 先于 P0 代码基座就位。
