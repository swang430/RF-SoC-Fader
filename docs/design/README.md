...
本目录为平台设计文档，分三册，**三册全部已冻结**：第一册（顶层设计）v1.0（2026-07-15，tag: `design-t1-v1.0`）· 第二册（功能设计）v1.0（2026-07-16，tag: `design-t2-v1.0`）· 第三册（测试设计）v1.0（2026-07-17，tag: `design-t3-v1.0`）。对已冻结册的后续变更需走 PR 评审并升版（先例：T1-03c v1.1→v1.2）。
...
- **第二册 · 功能设计** `10-modules/`（**已冻结 v1.0**，2026-07-16，tag: `design-t2-v1.0`）：[T2-00 模块地图](10-modules/T2-00-module-map.md)（清单/依赖/推进序）· [T2-01 协议编解码](10-modules/T2-01-protocol-codec.md)（M1，已合并）· [T2-02 设备后端/传输](10-modules/T2-02-device-backends.md)（M2，已合并）· [T2-04 RT-MPDB 导入](10-modules/T2-04-mpdb-import.md)（M4，已合并）· [T2-05 相关性合成](10-modules/T2-05-correlation.md)（M5，已合并）· [T2-03 引擎集成](10-modules/T2-03-engine-integration.md)（M3，已合并）· [T2-06 场景/会话管理](10-modules/T2-06-scenario-session.md)（M6，已合并）· [T2-07 API 网关](10-modules/T2-07-api-gateway.md)（M7，已合并）· [T2-08 遥测与校准](10-modules/T2-08-telemetry-calibration.md)（M8，已合并）· [T2-09 SDK](10-modules/T2-09-sdk.md)（M9，已合并）· [T2-10 格式与持久化](10-modules/T2-10-formats-persistence.md)（M10，已合并）· [T2-11 GUI](10-modules/T2-11-gui.md)（M11，已合并）——**第二册 11 个模块全部完成评审并合并，经 T1-15 设计问答与收官审查（PR #20）后冻结 v1.0（2026-07-16）**。T1-03c 已升版 v1.2（2026-07-16——v1.1 打包①完整 PortMap ②origin/frame ③phase_rad ④coeffs 外置复评；v1.2 随 MPDB 手册 v1.1/HyperRT v3.2.6 增 `Ray.doppler_hz?` 逐径多普勒可选字段）。下一步：第三册 T3 测试设计（**已冻结 v1.0**）→ P0 代码基座。
- **第三册 · 测试设计** `20-dev-test/`（**已冻结 v1.0**，2026-07-17，tag: `design-t3-v1.0`；六篇评审合并 2026-07-16，PR #22–#27；原 T1–T5 模块代号为避免与册号撞名改为 `T3-01…T3-05`）：[T3-00 测试治理总则](20-dev-test/T3-00-test-governance.md)（监督五原则/金字塔/追溯矩阵/挂账盘点/HIL 两级环，已合并）· [T3-01 测试仓库与流程](20-dev-test/T3-01-test-repo-process.md)（测试树/用例 ID/fixture 主权/测试栈/矩阵载体四查，已合并）· [T3-02 测试金字塔详规](20-dev-test/T3-02-pyramid-detail.md)（L1/L2 收编规约/五条补缺/L3-L4 矩阵/负向总账，已合并）· [T3-04 黄金一致性](20-dev-test/T3-04-golden-conformance.md)（G1–G11 资产登记/两条铁律/重录纪律，已合并）· [T3-03 硬件在环](20-dev-test/T3-03-hardware-in-the-loop.md)（HIL-C/HIL-R 细则/六项基线测量/台账兑现分型/报告模板/安全规程，已合并）· [T3-05 CI·发布·验收](20-dev-test/T3-05-ci-release-acceptance.md)（gate 编排/四项阈值定标程序/P0–P4 验收映射/发布 checklist，已合并）——**第三册六篇全部完成评审并合并（2026-07-16），冻结 v1.0（2026-07-17，tag: `design-t3-v1.0`）**。下一步：P0 代码基座——**测试先行**条件（T3-01/02/04）已随本册冻结就位；执行排程与当前 TODO 见 [`docs/plan/DP-01`](../plan/DP-01-todo-rt-tdl-first.md)（活文档：RT-TDL 生产力工具优先）。
