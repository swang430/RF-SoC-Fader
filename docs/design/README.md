...
- **第二册 · 功能设计** `10-modules/`（进行中）：[T2-00 模块地图](10-modules/T2-00-module-map.md)（清单/依赖/推进序）· [T2-01 协议编解码](10-modules/T2-01-protocol-codec.md)（M1，已合并）· [T2-02 设备后端/传输](10-modules/T2-02-device-backends.md)（M2，已合并）· [T2-04 RT-MPDB 导入](10-modules/T2-04-mpdb-import.md)（M4，已合并）· [T2-05 相关性合成](10-modules/T2-05-correlation.md)（M5，评审中）· 其余待开（M3 引擎集成 · M6 场景会话 · M7 API 网关 · M8 遥测校准 · M9 SDK · M10 格式与持久化 · M11 GUI）。
